...
const QUESTIONS = [
  ...
  {
    q: 'AI 翻译的「直译 vs 意译」区别在于？',
    options: ['直译保真但可能生硬，意译重流畅但可能偏离原意', '直译是中文，意译是英文', '两者完全一样', '直译更短'],
    answer: 0,
    explain: '直译贴近原文结构，意译按目标语言习惯重写。真实翻译常是两者结合，且必须人工校对专业术语和数字。',
  },
  {
...
const RECAP = [
  ...
  { icon: '🧠', t: '文档分析', d: '体检评分、摘要提取、翻译、AI 出题' },
...
export default function AiExam() {
  ...
  return (
    <LessonPage
      ...
      icon="🤖"
      title="AI 知识测验"
      subtitle="结业最后一关：12 道题检验你对 AI 辅助写作、表格与文档分析的掌握，60 分以上即可获得「结业认证」徽章。"
      goals={['回顾模块五的 AI 知识点', '答对 12 道概念选择题', '以 60 分以上通关并获得结业认证']}
    >
      ...
      <Section num={3} title="下一步">
        {done ? (
          ...
          <p style={{ color: 'var(--text-faint)' }}>答完 12 道题并拿到 60 分以上，即可获得结业认证 🎓</p>
        )}
      </Section>
    </LessonPage>
  )
